...
class CodecProfileLevelList {
    ...
    public boolean addCodecProfileLevel(String mimetype, CodecProfileLevel codecProfileLevel) {
        try {
            mList.add(
                    new CodecProfileLevelAdapter(
                            mimetype,
                            mediaCodecProfileToChromiumMediaProfile(
                                    mimetype, codecProfileLevel.profile),
                            mediaCodecLevelToChromiumMediaLevel(mimetype, codecProfileLevel.level)));
            return true;
    ...
    public boolean addCodecProfileLevel(String mimetype, int profile, int level) {
        mList.add(new CodecProfileLevelAdapter(mimetype, profile, level));
        return true;
    }
    ...
    public static int mediaCodecLevelToChromiumMediaLevel(String mimetype, int level) {
        switch (mimetype) {
            case MIMETYPE_VIDEO_AVC:
                switch (level) {
