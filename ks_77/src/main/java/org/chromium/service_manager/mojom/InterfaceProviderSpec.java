...
/* loaded from: xwalk_main_fat-77.3.aar:classes.jar:org/chromium/service_manager/mojom/InterfaceProviderSpec.class */
public final class InterfaceProviderSpec extends Struct {
    ...
    public static InterfaceProviderSpec decode(Decoder decoder0) {
        ...
        try {
            ...
            for (int i22 = 0; i22 < si22.elementsOrVersion; i22++) {
                Decoder decoder3 = decoder22.readPointer(8 + (8 * i22), false);
            ...
            for (int i24 = 0; i24 < si24.elementsOrVersion; i24++) {
                Decoder decoder32 = decoder24.readPointer(8 + (8 * i24), false);
                values02[i24] = CapabilitySet.decode(decoder32);
            }
            result.requires = new HashMap();
            for (int index02 = 0; index02 < keys02.length; index02++) {
                result.requires.put(keys02[index02], values02[index02]);
            }
            return result;
        } finally {
    ...
    public final void encode(Encoder encoder) {
        ...
        int size02 = this.requires.size();
        String[] keys02 = new String[size02];
        CapabilitySet[] values02 = new CapabilitySet[size02];
        int index02 = 0;
        for (Map.Entry<String, CapabilitySet> entry02 : this.requires.entrySet()) {
