...
/* loaded from: xwalk_main_fat-77.3.aar:classes.jar:org/chromium/service_manager/mojom/ProcessMetadata_Internal.class */
class ProcessMetadata_Internal {
    public static final Interface.Manager<ProcessMetadata, ProcessMetadata.Proxy> MANAGER = new Interface.Manager<ProcessMetadata, ProcessMetadata.Proxy>() { // from class: org.chromium.service_manager.mojom.ProcessMetadata_Internal.1
        ...
        public ProcessMetadata.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: xwalk_main_fat-77.3.aar:classes.jar:org/chromium/service_manager/mojom/ProcessMetadata_Internal$Proxy.class */
    public static final class Proxy extends Interface.AbstractProxy implements ProcessMetadata.Proxy {
        Proxy(Core core, MessageReceiverWithResponder messageReceiver) {
            super(core, messageReceiver);
        }

        @Override // org.chromium.service_manager.mojom.ProcessMetadata
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: xwalk_main_fat-77.3.aar:classes.jar:org/chromium/service_manager/mojom/ProcessMetadata_Internal$Stub.class */
    public static final class Stub extends Interface.Stub<ProcessMetadata> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    case -2:
                        return InterfaceControlMessagesHelper.handleRunOrClosePipe(ProcessMetadata_Internal.MANAGER, messageWithHeader);
                    case 0:
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), ProcessMetadata_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    /* loaded from: xwalk_main_fat-77.3.aar:classes.jar:org/chromium/service_manager/mojom/ProcessMetadata_Internal$ProcessMetadataSetPidParams.class */
