...
import org.libvlc.VMediaPlayer;
...
public class MediaPlayerBridge {
    ...
    private org.libvlc.VMediaPlayer mPlayer;
    ...
    protected org.libvlc.VMediaPlayer getLocalPlayer() {
        if (mPlayer == null) {
            mPlayer = new org.libvlc.VMediaPlayer();
        }
        return mPlayer;
    }
    ...
    protected void setOnCompletionListener(MediaPlayer.OnCompletionListener listener) {
        getLocalPlayer().setOnCompletionListener(new VMediaPlayer.OnCompletionListener() {
            @Override
    ...
    protected void setOnErrorListener(MediaPlayer.OnErrorListener listener) {
        getLocalPlayer().setOnErrorListener(new VMediaPlayer.OnErrorListener() {
            @Override
            public boolean onError(int what, int extra) {
                return listener.onError(null,what,extra);
            }
        });
    }

    protected void setOnPreparedListener(MediaPlayer.OnPreparedListener listener) {
        getLocalPlayer().setOnPreparedListener(new VMediaPlayer.OnPreparedListener() {
            @Override
    ...
    protected void setOnVideoSizeChangedListener(MediaPlayer.OnVideoSizeChangedListener listener) {
        getLocalPlayer().setOnVideoSizeChangedListener(new VMediaPlayer.OnVideoSizeChangedListener() {
            @Override
