...
/* loaded from: xwalk_main_fat-77.3.aar:classes.jar:org/chromium/gpu/mojom/GpuExtraInfo.class */
public final class GpuExtraInfo extends Struct {
    ...
    public final void encode(Encoder encoder) {
        ...
        Encoder encoder1 = encoder0.encodePointerArray(this.angleFeatures.length, 8, -1);
        for (int i0 = 0; i0 < this.angleFeatures.length; i0++) {
            encoder1.encode((Struct) this.angleFeatures[i0], 8 + (8 * i0), false);
        }
    }
}
