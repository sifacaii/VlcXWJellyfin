...
public class BakedBezierInterpolator implements Interpolator {
    ...
    public float getInterpolation(float input) {
        ...
        float weight = difference / this.mStepSize;
