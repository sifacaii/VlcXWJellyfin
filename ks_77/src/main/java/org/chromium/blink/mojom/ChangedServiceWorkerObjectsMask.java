...
/* loaded from: xwalk_main_fat-77.3.aar:classes.jar:org/chromium/blink/mojom/ChangedServiceWorkerObjectsMask.class */
public final class ChangedServiceWorkerObjectsMask extends Struct {
    ...
    public static ChangedServiceWorkerObjectsMask decode(Decoder decoder0) {
        ...
        try {
            ...
            ChangedServiceWorkerObjectsMask result = new ChangedServiceWorkerObjectsMask(elementsOrVersion);
