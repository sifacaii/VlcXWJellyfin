...
/* loaded from: xwalk_main_fat-77.3.aar:classes.jar:org/chromium/blink/mojom/SpeechRecognitionResult.class */
public final class SpeechRecognitionResult extends Struct {
    ...
    public final void encode(Encoder encoder) {
        ...
        if (this.hypotheses == null) {
            ...
            Encoder encoder1 = encoder0.encodePointerArray(this.hypotheses.length, 8, -1);
            for (int i0 = 0; i0 < this.hypotheses.length; i0++) {
                encoder1.encode((Struct) this.hypotheses[i0], 8 + (8 * i0), false);
            }
        }
