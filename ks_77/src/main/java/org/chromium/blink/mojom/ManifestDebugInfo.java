...
/* loaded from: xwalk_main_fat-77.3.aar:classes.jar:org/chromium/blink/mojom/ManifestDebugInfo.class */
public final class ManifestDebugInfo extends Struct {
    ...
    public final void encode(Encoder encoder) {
        ...
        if (this.errors == null) {
            ...
            Encoder encoder1 = encoder0.encodePointerArray(this.errors.length, 8, -1);
            for (int i0 = 0; i0 < this.errors.length; i0++) {
                encoder1.encode((Struct) this.errors[i0], 8 + (8 * i0), false);
            }
        }
