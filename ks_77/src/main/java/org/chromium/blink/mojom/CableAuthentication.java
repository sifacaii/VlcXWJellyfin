...
/* loaded from: xwalk_main_fat-77.3.aar:classes.jar:org/chromium/blink/mojom/CableAuthentication.class */
public final class CableAuthentication extends Struct {
    ...
    public static CableAuthentication decode(Decoder decoder0) {
        ...
        try {
            ...
            result.clientEid = decoder0.readBytes(16, 0, 16);
            result.authenticatorEid = decoder0.readBytes(24, 0, 16);
            result.sessionPreKey = decoder0.readBytes(32, 0, 32);
    ...
    public final void encode(Encoder encoder) {
        ...
        encoder0.encode(this.clientEid, 16, 0, 16);
        encoder0.encode(this.authenticatorEid, 24, 0, 16);
        encoder0.encode(this.sessionPreKey, 32, 0, 32);
    }
}
