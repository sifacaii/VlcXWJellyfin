...
/* loaded from: xwalk_main_fat-77.3.aar:classes.jar:org/chromium/network/mojom/NetworkUsage.class */
public final class NetworkUsage extends Struct {
    ...
    public static NetworkUsage deserialize(ByteBuffer data) {
        return deserialize(new Message(data, new ArrayList()));
    }

    public static NetworkUsage decode(Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        ...
        try {
            ...
            NetworkUsage result = new NetworkUsage(elementsOrVersion);
