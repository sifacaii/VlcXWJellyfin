...
/* loaded from: xwalk_main_fat-77.3.aar:classes.jar:org/chromium/network/mojom/MutablePartialNetworkTrafficAnnotationTag.class */
public final class MutablePartialNetworkTrafficAnnotationTag extends Struct {
    ...
    public static MutablePartialNetworkTrafficAnnotationTag decode(Decoder decoder0) {
        ...
        try {
            ...
            MutablePartialNetworkTrafficAnnotationTag result = new MutablePartialNetworkTrafficAnnotationTag(elementsOrVersion);
