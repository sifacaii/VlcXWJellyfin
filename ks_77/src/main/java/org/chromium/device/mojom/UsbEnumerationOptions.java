...
/* loaded from: xwalk_main_fat-77.3.aar:classes.jar:org/chromium/device/mojom/UsbEnumerationOptions.class */
public final class UsbEnumerationOptions extends Struct {
    ...
    public final void encode(Encoder encoder) {
        ...
        for (int i0 = 0; i0 < this.filters.length; i0++) {
            encoder1.encode((Struct) this.filters[i0], 8 + (8 * i0), false);
        }
    }
}
